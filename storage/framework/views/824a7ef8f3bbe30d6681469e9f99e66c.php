        ...
        <div class="card bg-secondary shadow border-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            ...
            <div class="text-center text-muted mb-4">
              <small>Ingresa tus credenciales para Iniciar Sesión</small>
            </div>
            <?php endif; ?>
            ...
            <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
              ...
              <div class="form-group mb-3">
                <div class="input-group input-group-alternative">
                  ...
                  <input class="form-control" placeholder="Correo Electrónico" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
                </div>
              </div>
...
<?php echo $__env->make('layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Version_nueva_Laravel\Version_03\CAM\resources\views/auth/login.blade.php ENDPATH**/ ?>