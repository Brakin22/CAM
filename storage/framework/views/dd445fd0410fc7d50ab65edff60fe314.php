...
<body class="">
    ...
    <div class="container-fluid">
      ...
      <ul class="nav align-items-center d-md-none">
        ...
        <li class="nav-item dropdown">
          ...
          <?php echo $__env->make('includes.panel.userOptions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </li>
      </ul>
      <!-- Collapse -->
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
      ...
      <?php echo $__env->make('includes.panel.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
  </div>
  <!--   Core   -->
...
</html><?php /**PATH C:\xampp\htdocs\Version_nueva_Laravel\Version_03\CAM\resources\views/layouts/panel.blade.php ENDPATH**/ ?>