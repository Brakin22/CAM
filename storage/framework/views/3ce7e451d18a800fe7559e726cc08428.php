            ...
            <form role="form" method="POST" action="<?php echo e(route('register')); ?>">
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative mb-3">
                  ...
                  <input class="form-control" placeholder="Correo Electrónico" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email">
                </div>
              </div>
              <div class="form-group">
...
<?php echo $__env->make('layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Version_nueva_Laravel\Version_03\CAM\resources\views/auth/register.blade.php ENDPATH**/ ?>